...
enum
{
    ...
    FORKID_BITCOINFAITH = 70, // ASCII F
};

static const int FORKID_IN_USE = FORKID_BITCOINFAITH;
...
enum
{
    ...
    // Allow NON_FORKID in legacy tests and blocks under BTF hard fork height
    //
