...
public:
    CMainParams() {
        ...
        consensus.BTGHeight = 500000; // Around 12/18/2017 22:00 UTC
        consensus.LastBlockHasSubsidy = 1411200;
        ...
        consensus.BitcoinPostforkTime = 1513622125;
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000cd179b97f77d83d1073aa6");
        ...
        nDefaultPort = 8346; // different port than Bitcoin
     ...
     //   vSeeds.emplace_back("dnsseed.bitcoinfaith.org", true);
	vSeeds.emplace_back("a.btf.hjy.cc", true);
	vSeeds.emplace_back("b.btf.hjy.cc", true);
	vSeeds.emplace_back("c.btf.hjy.cc", true);
	vSeeds.emplace_back("d.btf.hjy.cc", true);
	vSeeds.emplace_back("e.btf.hjy.cc", true);
	vSeeds.emplace_back("f.btf.hjy.cc", true);


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,36);  // prefix: F
...
public:
    CTestNetParams() {
        ...
        consensus.BTGHeight = 201601;
        consensus.LastBlockHasSubsidy = 1411200;
        consensus.BTGPremineWindow = 1;
        consensus.BTGPremineEnforceWhitelist = false;
        consensus.BitcoinPostforkBlock = uint256S("00000000d16d6c2aecc7436eea0c54a53741fee9abf265606aa465d6fd3f3d8a");
        consensus.BitcoinPostforkTime = 1513310912;
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000453e926d09ebe87");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000000000376bb71314321c45de3015fe958543afcbada242a3b1b072498e38"); //201600
        ...
        vSeeds.emplace_back("test-dnsseed.bitcoinfaith.org", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0x60); // f
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,0x65); // h
