...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Bitcoin Faith bootstrap mode. Allows BTF client to connect to Bitcoin p2p network to download blockahin history."));
